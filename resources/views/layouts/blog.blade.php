...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen font-sans text-gray-900 dark:text-gray-100">
    ...
    <main class="max-w-5xl mx-auto px-4 flex flex-col md:flex-row gap-8">
